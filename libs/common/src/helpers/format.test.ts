...
describe('format', () => {
  const emptyInputs = ['', ' ', {}, []];
  it.each(emptyInputs)('should return the same output when the input is empty `%s`', (input) => {
    // Act
  ...
  it('should return formatted output when the input is an object', () => {
    // Arrange
    const input = {
      version: 1,
  ...
  it('should return formatted output when the input is an object with nested input', () => {
    // Arrange
    const input = {
      version: 35,
      criteria: [
