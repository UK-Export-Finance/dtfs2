...
import { createReferenceNumber } from './create-amendment-reference-number';
...
describe('createReferenceNumber', () => {
  ...
  it('should return the correct reference number with padded amendment number', () => {
    ...
    const result = createReferenceNumber(amendmentsOnFacility, mockUkefFacilityId);
  ...
  it('should pad amendment number with zeros up to 3 digits', () => {
    ...
    const result = createReferenceNumber(amendments, mockUkefFacilityId);
