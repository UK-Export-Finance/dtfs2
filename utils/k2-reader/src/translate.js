...
const map = async (k2xml) => {
  ...
  let mapped = {
    ...
    eligibility:          eligibility(k2Deal),
    bondTransactions:     bondTransactions(k2Deal),
    loanTransactions:     loanTransactions(k2Deal),
    summary:              summary(k2Deal),
    comments:             comments(k2Deal),
    submissionDetails:    submissionDetails(k2Deal),
  };
...
const aboutSupplyContract = (k2Deal) => {
  return {
    status:             "NEEDS-MAPPING"
  }
};

const eligibility = (k2Deal) => {
    return {
      status:               "NEEDS-MAPPING",
      submissionType:       "NEEDS-MAPPING",
...
const submissionDetails = (k2Deal) => {
  return {
