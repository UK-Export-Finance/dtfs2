...
const createInitialTfmUser = async (user) => {
  await axios({
    ...
    console.error('Unable to create initial TFM user %o', error);
  });
};
...
const loginTfmUser = async (user) => {
  const response = await axios({
    ...
    console.error('Unable to login as TFM user %o', error);
  });
...
const deleteBank = async (deal, token) => {
  const response = await axios({
    ...
    console.error('Error when deleting bank %o', error);
  });
...
const listBanks = async (token) => {
  const response = await axios({
    ...
    console.error('Error when listing banks %o', error);
  });
