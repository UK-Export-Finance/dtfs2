module.exports = [
  {
    ...
    criteria: [
      ...
      {
        id: 2,
        description: 'The cover period for each Transaction does not exceed 36 months for bonds or 24 months for working capital loans, or such other period approved by UKEF (that has not lapsed or been withdrawn) in relation to bonds and/or loans for this Obligor.',
      },
      {
        id: 3,
        description: 'The total UKEF exposure for this Transaction and any prior live covered Transactions for this Obligor does not exceed £2 million, or such other limit approved by UKEF (that has not lapsed or been withdrawn) in relation to this Obligor.',
      },
      {
        id: 4,
        description: 'For a bond Transaction, the bond has not yet been issued or, where the bond has been issued, this was done no more than 30 calendar days prior to the submission of this Inclusion Notice. For a loan Transaction, the loan has not yet been made irrevocably available for disbursement.',
      },
      {
        id: 5,
        description: 'The Supplier has provided the bank with a duly completed Supplier Declaration, and the Bank is not aware that any of the information contained within it is inaccurate.',
      },
      {
        id: 6,
        description: 'The Transaction is not an Affected Transaction i.e. the Bank Team is not aware of any event or circumstance which might result in a demand under the bond or default on a loan, or adverse event in relation to the Supply Contract.',
      },
      {
        id: 7,
        description: 'The Bank has complied with its policies and procedures in relation to the Transaction.',
      },
      {
        id: 8,
        description: 'The Requested Cover Start Date is no more than one month from the date of submission.',
      },
      {
        id: 9,
      ...
      {
        id: 10,
        description: 'Where the Supplier is a UK Supplier, the Supplier has provided the Bank with a duly completed UK Supplier Declaration, and the Bank is not aware that any of the information contained within it is inaccurate.',
      },
      {
        id: 11,
        description: 'The Supplier has confirmed in its Supplier Supplementary Declaration that it does not operate in any of the following Controlled Sectors: sharp arms defence, nuclear, radiological, biological, human cloning, pornography, tobacco or gambling, and the Bank is not aware that any of the information contained within it is inaccurate.',
      },
      {
        id: 12,
        description: 'Either the Supplier or, where applicable, the Guarantor has an annual turnover of not less than £1 million per the most recent annual audited or, where exempted, unaudited statutory financial statements.',
      },
      {
        id: 13,
        description: 'Either the Supplier or, where applicable, the Guarantor has a net worth greater than zero per the most recent annual audited or, where exempted, unaudited statutory financial statements.',
      },
      {
        id: 14,
        description: 'Either the Supplier or, where applicable, the Guarantor has a Current Ratio of not less than 0.5 per the most recent annual audited or, where exempted, unaudited statutory financial statements.',
      },
      {
        id: 15,
        description: 'Either the Supplier or, where applicable, the Guarantor has supplied the Bank with copies of its annual audited or, where exempted, unaudited statutory financial statements for at least the three most recent consecutive financial years.',
      },
      {
        id: 16,
      ...
      {
        id: 17,
        description: 'Either the Supplier or the Guarantor has a probability of default of not more than 14.1%.',
      },
      {
        id: 18,
      ...
      {
        id: 22,
        description: 'The Bank is the sole and beneficial owner of, and has legal title to, the Transaction.',
      },
      {
        id: 23,
        description: 'The Bank has not made a Disposal (other than a Permitted Disposal) or a Risk Transfer (other than a Permitted Risk Transfer) in relation to the Transaction.',
      },
      {
        id: 24,
        description: 'The Bank\'s right, title and interest in relation to the Transaction is clear of any Security and Quasi-Security (other than Permitted Security) and is freely assignable without the need to obtain consent of any Obligor or any other person.',
      },
      {
        id: 25,
        description: 'The Bank is not restricted or prevented by any agreement with an Obligor from providing information and records relating to the Transaction.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    criteria: [
      ...
      },
      {
        id: 18,
        description:
          "The fees, interest rate and/or risk margin apply to the whole Cover Period, and have been set in accordance with the Bank's normal pricing policies and include, if any, pricing requirements set by UKEF.",
      },
    ],
  },
  {
