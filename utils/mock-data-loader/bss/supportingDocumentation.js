const SUPPORTING_DOCUMENTATION = [
  {
    ...
    description:
      'Please upload a completed Manual Inclusion Questionnaire. You can download the template here: <a href="#" class="govuk-link">Manual Inclusion Questionnaire</a>',
    inputType: 'file',
  },
  {
    ...
    description:
      'Financial statements (audited if available) for the past 3 years, including a Profit & Loss, Balance Sheet and Cash Flow Statement, (with notes, if applicable). If the company is part of a larger group, separate accounts should be provided for the company and group.',
    inputType: 'file',
  },
  {
  ...
  },
  {
    ...
    description:
      'Including monthly cash-flow projections for the business as a whole. If unavailable provide for at least the projected facility/guarantee term. If there are any cash flow shortfalls, explain how these will be filled.',
    inputType: 'file',
  },
  {
  ...
  },
  {
    ...
    title: 'Security',
    description:
      'Details of the overarching general facility taken by the bank in relation to the exporter, for example debenture, fixed and floating charge, but not including any security that is specific to the Transaction.',
    inputType: 'textarea',
  },
];
