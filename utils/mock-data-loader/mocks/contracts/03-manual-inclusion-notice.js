...
module.exports = {
  ...
  details: {
    bank: 'UKEF test bank',
    bankSupplyContractID: 'MIA-Msstar-BSS-DGR-2',
    bankSupplyContractName: 'MIA deal - Manual Inclusion Notice',
    ukefDealId: '20010739',
  ...
  bondTransactions: {
    items: [
      {
        id: '1',
        uniqueIdentificationNumber: 'unique9',
      ...
      {
        id: '2',
        uniqueIdentificationNumber: 'unique10',
        ukefFacilityID: '12345678',
        value: 'GBP 123,456.00',
        bondStage: 'Unissued',
        startDate: '12/02/2020',
