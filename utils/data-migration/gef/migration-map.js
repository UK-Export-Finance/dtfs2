...
const SUPPORTING_INFORMATION = {
  file_1: V2_CONSTANTS.DEAL.GEF_SUPPORTING_INFORMATION.MANUAL_INCLUSION,
  file_2: V2_CONSTANTS.DEAL.GEF_SUPPORTING_INFORMATION.AUDITED_FINANCIAL_STATEMENTS,
  file_3: V2_CONSTANTS.DEAL.GEF_SUPPORTING_INFORMATION.YEAR_TO_DATE_MANAGEMENT_ACCOUNTS,
  file_4: V2_CONSTANTS.DEAL.GEF_SUPPORTING_INFORMATION.FINANCIAL_FORECASTS,
  file_5: V2_CONSTANTS.DEAL.GEF_SUPPORTING_INFORMATION.FINANCIAL_INFORMATION,
  file_6: V2_CONSTANTS.DEAL.GEF_SUPPORTING_INFORMATION.CORPORATE_STRUCTURE,
};
...
const BASIS_DETAILS = {
  ...
  'a facility provided on a revolving or renewing basis':
    V2_CONSTANTS.FACILITIES.GEF_FACILITY_PROVIDED_DETAILS.RESOLVING,
  ...
  'a facility provided on an on-demand or overdraft basis':
    V2_CONSTANTS.FACILITIES.GEF_FACILITY_PROVIDED_DETAILS.ON_DEMAND,
  'a factoring facility provided on a with-recourse basis':
    V2_CONSTANTS.FACILITIES.GEF_FACILITY_PROVIDED_DETAILS.FACTORING,
};
