...
resource gefUi 'Microsoft.Web/sites@2022-09-01' = {
  name: gefUiName
  location: location
  tags: {
...
resource gefUiSettings 'Microsoft.Web/sites/config@2022-09-01' = {
  parent: gefUi
  name: 'appsettings'
  properties: appSettings
}

resource gefUiConnectionStrings 'Microsoft.Web/sites/config@2022-09-01' = {
  parent: gefUi
...
resource gefUiPrivateEndpoint 'Microsoft.Network/privateEndpoints@2022-11-01' = {
...
output defaultHostName string = gefUi.properties.defaultHostName
