...
param PORTAL_REPORTING_DUE_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH string
param PORTAL_REPORT_DUE_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH string
param PORTAL_REPORT_OVERDUE_CHASER_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH string
param PORTAL_REPORTING_PERIOD_START_EMAIL_SCHEDULE string
param PORTAL_REPORT_DUE_EMAIL_SCHEDULE string
param PORTAL_REPORT_OVERDUE_EMAIL_SCHEDULE string
...
var portalApiSettings = {
  ...
  PORTAL_REPORTING_DUE_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH: PORTAL_REPORTING_DUE_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH
  PORTAL_REPORT_DUE_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH: PORTAL_REPORT_DUE_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH
  PORTAL_REPORT_OVERDUE_CHASER_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH: PORTAL_REPORT_OVERDUE_CHASER_DATE_BUSINESS_DAYS_FROM_START_OF_MONTH
  PORTAL_REPORTING_PERIOD_START_EMAIL_SCHEDULE: PORTAL_REPORTING_PERIOD_START_EMAIL_SCHEDULE
  PORTAL_REPORT_DUE_EMAIL_SCHEDULE: PORTAL_REPORT_DUE_EMAIL_SCHEDULE
  PORTAL_REPORT_OVERDUE_EMAIL_SCHEDULE: PORTAL_REPORT_OVERDUE_EMAIL_SCHEDULE
}
