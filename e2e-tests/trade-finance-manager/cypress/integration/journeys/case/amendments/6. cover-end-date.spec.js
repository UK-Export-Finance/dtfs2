...
context('Amendments request page', () => {
  describe('Amendments request', () => {
    ...
    it('should NOT allow users to enter the same cover end date', () => {
      ...
      amendmentsPage.amendmentCoverEndDateDayInput().type(20);
      amendmentsPage.amendmentCoverEndDateMonthInput().type(10);
      amendmentsPage.amendmentCoverEndDateYearInput().type(2020);
      amendmentsPage.continueAmendment().click();
    ...
    it('should continue to `Check your answers` page if the cover end date is valid', () => {
      ...
      amendmentsPage.continueAmendment().click();
      cy.url().should('contain', 'cover-end-date');
      amendmentsPage.amendmentCoverEndDateDayInput().type(dateConstants.todayDay);
      amendmentsPage.amendmentCoverEndDateMonthInput().type(dateConstants.todayMonth);
      amendmentsPage.amendmentCoverEndDateYearInput().type(dateConstants.todayYear);
      amendmentsPage.continueAmendment().click();
