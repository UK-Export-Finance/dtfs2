...
context('Amendments underwriting - add underwriter decision', () => {
  ...
  it('should take you to `Underwriting` page once a manual amendment has been submitted with underwriter managers decision and conditions/reasons/comments displayed', () => {
    cy.login(UNDERWRITER_MANAGER_1);
    cy.visit(relative(`/case/${dealId}/underwriting`));
