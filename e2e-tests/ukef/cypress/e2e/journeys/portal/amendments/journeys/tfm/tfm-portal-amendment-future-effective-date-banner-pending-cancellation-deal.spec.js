...
context(
  'Amendments - TFM - TFM should not display banners when there are portal amendments with future effective dates and the deal is pending cancellation',
  () => {
    let dealId;
    let facilityId1;
    let facilityId2;
