...
context(
  'Amendments - TFM - Correct values should be displayed when multiple amendments with empty string reference numbers are made to a facility, and a value portal amendment with reference number is subsequently made',
  () => {
    let dealId;
    ...
    it('should display the amended coverEndDate and tenor on facility summary list for the amendment with empty string reference number', () => {
