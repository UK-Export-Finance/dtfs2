...
context(
  'Amendments - TFM - Correct values should be displayed when multiple amendments with empty string reference numbers are made to a facility, and a portal amendment with reference number is subsequently made',
  () => {
    let dealId;
      ...
      cy.insertOneGefDeal(MOCK_APPLICATION_AIN_DRAFT, BANK1_MAKER1).then((insertedDeal) => {
        ...
        cy.createGefFacilities(dealId, [mockFacility], BANK1_MAKER1).then((createdFacility) => {
          ...
          cy.loginAndSubmitPortalAmendmentRequestToUkef({
            ...
            changedFacilityValue: CHANGE_FACILITY_VALUE_3,
