...
context('Amendments - TFM - Amendments details page - Portal amendment in progress bar when a deal is pending cancellation', () => {
  let dealId;
  let facilityId;
  ...
  it('should not display a portal amendment in progress bar when portal amendment is in progress and the deal is pending cancellation', () => {
