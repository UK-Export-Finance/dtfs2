...
import { D_MMMM_YYYY_FORMAT, twoDays, oneMonth, tomorrow } from '@ukef/dtfs2-common/test-helpers';
...
context('Amendments - Multiple cover end date amendments and bank review date - Application details displays amendment values on facility summary list', () => {
  let dealId;
  let facilityId;
    ...
    cy.insertOneGefDeal(MOCK_APPLICATION_AIN_DRAFT, BANK1_MAKER1).then((insertedDeal) => {
      ...
      cy.createGefFacilities(dealId, [mockFacility], BANK1_MAKER1).then((createdFacility) => {
        ...
        cy.loginAndSubmitPortalAmendmentRequestToUkef({
          ...
          changedBankReviewDate: twoDays.date,
