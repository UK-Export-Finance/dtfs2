...
const mockFacility2 = {
  ...mockFacility,
  ukefFacilityId: '0020000011',
};

const CHANGED_FACILITY_VALUE_1 = '20000';
const CHANGED_FACILITY_VALUE_2 = '30000';

context('Amendments - Multiple mixed status amendments - Application details displays correct task comments headings', () => {
  let dealId;
  let facilityId1;
  let facilityId2;
  ...
  describe('As a maker', () => {
    ...
    it(`should display an amendment with the ${PORTAL_AMENDMENT_STATUS.READY_FOR_CHECKERS_APPROVAL} heading in task comments section`, () => {
    ...
    it(`should display an amendment with the ${PORTAL_AMENDMENT_STATUS.FURTHER_MAKERS_INPUT_REQUIRED} heading in task comments section`, () => {
      ...
      cy.assertText(applicationPreview.amendmentDetailsFurtherMakersInputLink(1), `Facility (${ukefFacilityId1}) amendment details`);
    });
  ...
  describe('As a checker', () => {
    ...
    it(`should NOT display the ${PORTAL_AMENDMENT_STATUS.FURTHER_MAKERS_INPUT_REQUIRED} heading`, () => {
      ...
      applicationPreview.amendmentDetailsFurtherMakersInputLink(1).should('not.exist');
    });
