...
context(
  'Amendments - Single cover end date AND value amendment AND bank review date - Application details displays amendment values on facility summary list',
  () => {
    let dealId;
    let facilityId;
    ...
    it('should display the updated amendment value AND cover end date AND bank review date on facility summary list', () => {
