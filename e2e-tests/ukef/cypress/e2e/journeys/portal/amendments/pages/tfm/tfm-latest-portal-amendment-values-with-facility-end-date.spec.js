...
import { D_MMMM_YYYY_FORMAT, tomorrow, twoYears } from '@ukef/dtfs2-common/test-helpers';
...
context('Amendments - TFM - Latest values for portal amendment - Facility End Date', () => {
    ...
    cy.insertOneGefDeal(MOCK_APPLICATION_AIN_DRAFT, BANK1_MAKER1).then((insertedDeal) => {
      ...
      cy.createGefFacilities(dealId, [mockFacility], BANK1_MAKER1).then((createdFacility) => {
        ...
        cy.loginAndSubmitPortalAmendmentRequestToUkef({
          ...
          changedFacilityEndDate: tomorrow.date,
  ...
  it('should display the latest amended values on facility summary list', () => {
    ...
    const facilityEndDateFormatted = format(new Date(tomorrow.date), D_MMMM_YYYY_FORMAT);
