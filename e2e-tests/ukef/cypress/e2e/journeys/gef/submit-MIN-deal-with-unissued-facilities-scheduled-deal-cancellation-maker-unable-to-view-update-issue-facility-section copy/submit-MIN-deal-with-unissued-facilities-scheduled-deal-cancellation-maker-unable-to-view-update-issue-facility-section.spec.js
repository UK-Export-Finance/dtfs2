...
import { anUnissuedContingentFacility } from '../../../../../../e2e-fixtures/mock-gef-facilities';
...
context('Portal to TFM deal submission', () => {
  ...
  before(() => {
    ...
    cy.insertOneGefDeal(MOCK_APPLICATION_MIN_DRAFT, BANK1_MAKER1).then((insertedDeal) => {
      ...
      cy.createGefFacilities(dealId, [anUnissuedContingentFacility()], BANK1_MAKER1).then((createdFacilities) => {
  ...
  it('Gef MIN deal with unissued facilities is submitted to UKEF, user cancel deal in TFM. Maker unable to view update issue facility section on portal', () => {
    //---------------------------------------------------------------
