...
const UNDERWRITER_1 = MOCK_TFM_USERS.find(
  (user) => user.teams.includes(TFM_USER_TEAMS.UNDERWRITERS) && user.username === 'UNDERWRITER_1',
);
...
const T1_USER_1 = MOCK_TFM_USERS.find(
  (user) => user.teams.includes(TFM_USER_TEAMS.TEAM1) && user.username === 'T1_USER_1',
);

const RISK_MANAGER_1 = MOCK_TFM_USERS.find(
  (user) => user.teams.includes(TFM_USER_TEAMS.RISK_MANAGERS) && user.username === 'RISK_MANAGER_1',
);
...
const PIM_USER_1 = MOCK_TFM_USERS.find(
  (user) => user.teams.includes(TFM_USER_TEAMS.PIM) && user.username === 'PIM_USER_1',
);
