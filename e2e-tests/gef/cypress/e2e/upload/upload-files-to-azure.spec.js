...
context('Upload files to Azure', () => {
  ...
  describe('Upload files as a Maker', () => {
    ...
    it('should mark all Eligibility criteria answers as `False`', () => {
      ...
      uploadFiles
        .supportingInfoManualInclusionButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value .govuk-link')
        .should('contain', 'test.pdf (47 kB)');
      uploadFiles
        .supportingInfoManagementAccountsButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
      uploadFiles
        .supportingInfoFinancialStatementsButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
      uploadFiles
        .supportingInfoFinancialForecastsButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
      uploadFiles
        .supportingInfoFinancialCommentaryButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
      uploadFiles
        .supportingInfoCorporateStructureButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
      uploadFiles
        .supportingInfoDebtorCreditorButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
      uploadFiles
        .supportingInfoSecurityDetailsButton()
        .parent()
        .parent()
        .find('.govuk-summary-list__value')
        .should('contain', 'Required');
    ...
    it('should allow the same document to be uploaded in different sections', () => {
      ...
      cy.url().should(
        'eq',
        relative(`/gef/application-details/${dealId}/supporting-information/document/management-accounts`),
      );
      cy.uploadFile(
        'file1.png',
        `/gef/application-details/${dealId}/supporting-information/document/management-accounts/upload`,
      );
    ...
    it('should upload files to the `Financial Statements` section', () => {
      ...
      cy.url().should(
        'eq',
        relative(`/gef/application-details/${dealId}/supporting-information/document/financial-statements`),
      );
      cy.uploadFile(
        'file1.png',
        `/gef/application-details/${dealId}/supporting-information/document/financial-statements/upload`,
      );
      uploadFiles.uploadSuccess('file1.png').should('exist');
    });
    ...
    it('should upload files to the `Financial Forecasts` section', () => {
      ...
      cy.url().should(
        'eq',
        relative(`/gef/application-details/${dealId}/supporting-information/document/financial-forecasts`),
      );
      cy.uploadFile(
        'file1.png',
        `/gef/application-details/${dealId}/supporting-information/document/financial-forecasts/upload`,
      );
      uploadFiles.uploadSuccess('file1.png').should('exist');
    ...
    it('should upload files to the `Financial Commentary` section', () => {
      ...
      cy.url().should(
        'eq',
        relative(`/gef/application-details/${dealId}/supporting-information/document/financial-commentary`),
      );
      cy.uploadFile(
        'file2.png',
        `/gef/application-details/${dealId}/supporting-information/document/financial-commentary/upload`,
      );
      uploadFiles.uploadSuccess('file2.png').should('exist');
    ...
    it('should upload files to the `Corporate Structure` section', () => {
      ...
      cy.url().should(
        'eq',
        relative(`/gef/application-details/${dealId}/supporting-information/document/corporate-structure`),
      );
      cy.uploadFile(
        'file4.png',
        `/gef/application-details/${dealId}/supporting-information/document/corporate-structure/upload`,
      );
    ...
    it('should upload files to the `Debtor Creditor` section', () => {
      ...
      cy.url().should(
        'eq',
        relative(`/gef/application-details/${dealId}/supporting-information/document/debtor-creditor-reports`),
      );
      cy.uploadFile(
        'file4.png',
        `/gef/application-details/${dealId}/supporting-information/document/debtor-creditor-reports/upload`,
      );
      uploadFiles.uploadSuccess('file4.png').should('exist');
