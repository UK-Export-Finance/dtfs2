...
import { BANK1_MAKER1, BANK1_CHECKER1_WITH_MOCK_ID } from '../../../../../e2e-fixtures/portal-users.fixture';
...
context('Make a change button - FF_PORTAL_FACILITY_AMENDMENTS_ENABLED feature flag disabled', () => {
  before(() => {
