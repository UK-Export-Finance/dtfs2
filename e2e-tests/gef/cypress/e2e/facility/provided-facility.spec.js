...
context('Provided Facility Page', () => {
  ...
  describe('Visiting page as cash facility', () => {
    ...
    it('hides back button if visiting page with `change` query', () => {
      cy.visit(
        relative(
          `/gef/application-details/${applications[1].id}/facilities/${applications[1].facilities[1].details._id}/provided-facility?status=change`,
        ),
      );
  ...
  describe('Visiting page as contingent facility', () => {
    it('displays the correct elements', () => {
      cy.visit(
        relative(
          `/gef/application-details/${applications[2].id}/facilities/${applications[2].facilities[2].details._id}/provided-facility`,
        ),
      );
      providedFacility.backLink();
      providedFacility.headingCaption();
