...
import { threeYears, twoYears, today, threeMonths as threeMonthsOneDay } from '../../../../../../../e2e-fixtures/dateConstants';
...
*/
context('Unissued Facilities MIN - change to issued from preview page - specialIssuedPermission - feature flag enabled', () => {
  before(() => {
  ...
  describe('Change facility to issued from application preview', () => {
    ...
    it('should be able to update facility and then go back to application preview page with coverStartDate more than 3 months in the future', () => {
      ...
      cy.keyboardInput(facilityEndDate.facilityEndDateDay(), threeYears.day);
      cy.keyboardInput(facilityEndDate.facilityEndDateMonth(), threeYears.month);
      cy.keyboardInput(facilityEndDate.facilityEndDateYear(), threeYears.year);
      cy.clickContinueButton();
