...
import { threeDaysAgo, twoMonths, threeMonthsOneDay, today, threeMonths, threeDaysAgoPlusMonth } from '../../../../../../../e2e-fixtures/dateConstants';
...
context('Change issued facilities back to unissued AIN (changed to issued facilities post submission) - feature flag enabled', () => {
  ...
  describe('Change facility to issued from unissued table', () => {
    ...
    it('the correct success messages should be displayed after changing facility to issued', () => {
      ...
      cy.keyboardInput(facilityEndDate.facilityEndDateDay().clear(), threeMonthsOneDay.day);
      cy.keyboardInput(facilityEndDate.facilityEndDateMonth().clear(), threeMonthsOneDay.month);
      cy.keyboardInput(facilityEndDate.facilityEndDateYear().clear(), threeMonthsOneDay.year);
      cy.clickContinueButton();
