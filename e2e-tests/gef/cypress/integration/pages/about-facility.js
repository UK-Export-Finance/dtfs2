...
const aboutFacility = {
  ...
  hasCoverStartDateError: () => cy.get('[data-cy="has-cover-start-date-error"]'),
  coverStartDateYearYes: () => cy.get('[data-cy="cover-start-date-year-yes"]'),
  coverStartDateYearNo: () => cy.get('[data-cy="cover-start-date-year-no"]'),
