...
context('User submit feedback on portal', () => {
  ...
  it('feedback should give errors if incorrectly filled up', () => {
    ...
    feedbackPage.emailAddressErrorMessage().contains('Enter an email address in the correct format, like name@ukexportfinance.gov.uk');
    ...
    errorSummary().contains('Enter an email address in the correct format, like name@ukexportfinance.gov.uk');
  });
