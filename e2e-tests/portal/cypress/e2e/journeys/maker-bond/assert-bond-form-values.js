...
const details = {
  ...
  issued: () => {
    ...
    pages.bondDetails
      ...
      .should('have.value', BOND_FORM_VALUES.DETAILS.requestedCoverStartDateDay);
    pages.bondDetails
      .requestedCoverStartDateMonthInput()
      .should('have.value', BOND_FORM_VALUES.DETAILS.requestedCoverStartDateMonth);
    pages.bondDetails
      .requestedCoverStartDateYearInput()
      .should('have.value', BOND_FORM_VALUES.DETAILS.requestedCoverStartDateYear);
...
const financialDetails = {
  currencySameAsSupplyContractCurrency: () => {
    pages.bondFinancialDetails
      .facilityValueInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.valueFormatted);
    pages.bondFinancialDetails.currencySameAsSupplyContractCurrencyYesInput().should('be.checked');
    pages.bondFinancialDetails
      .riskMarginFeeInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.riskMarginFee);
    pages.bondFinancialDetails
      .coveredPercentageInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.coveredPercentage);
    pages.bondFinancialDetails
      .minimumRiskMarginFeeInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.minimumRiskMarginFee);
    pages.bondFinancialDetails
      .ukefExposureInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.ukefExposure);
    pages.bondFinancialDetails
      .guaranteeFeePayableByBankInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.guaranteeFeePayableByBank);
  },
  transactionCurrencyNotTheSameAsSupplyContractCurrency: () => {
    ...
    pages.bondFinancialDetails
      .conversionRateInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.conversionRate);
    pages.bondFinancialDetails
      .conversionRateDateDayInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.conversionRateDateDay);
    pages.bondFinancialDetails
      .conversionRateDateMonthInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.conversionRateDateMonth);
    pages.bondFinancialDetails
      .conversionRateDateYearInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.conversionRateDateYear);
    pages.bondFinancialDetails
      .riskMarginFeeInput()
      .should('have.value', BOND_FORM_VALUES.FINANCIAL_DETAILS.riskMarginFee);
    pages.bondFinancialDetails
