const { MAKER, CHECKER, READ_ONLY } = require('../../../../portal/server/constants/roles');
...
const BANK1_READ_ONLY1 = MOCK_USERS.find((user) => user.roles.includes(READ_ONLY) && user.username === 'BANK1_READ_ONLY1');
