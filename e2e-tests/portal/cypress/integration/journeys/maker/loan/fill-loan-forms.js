...
const guaranteeDetails = {
  facilityStageConditional: () => {
    ...
    pages.loanGuaranteeDetails.conditionalBankReferenceNumberInput()
      .type(LOAN_FORM_VALUES.GUARANTEE_DETAILS.bankReferenceNumber);
  ...
  facilityStageUnconditional: () => {
    ...
    pages.loanGuaranteeDetails.unconditionalBankReferenceNumberInput()
      .type(LOAN_FORM_VALUES.GUARANTEE_DETAILS.bankReferenceNumber);
