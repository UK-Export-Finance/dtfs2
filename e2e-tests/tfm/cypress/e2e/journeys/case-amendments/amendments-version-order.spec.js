...
context(
  'Amendments underwriting - amendments should be in correct order of versions (including when withdrawn)',
  () => {
    let dealId;
    ...
    it('should submit and complete and amendment', () => {
      ...
      amendmentsPage.amendmentDetails
        ...
        .should('contain', UNDERWRITER_MANAGER_DECISIONS.APPROVED_WITHOUT_CONDITIONS);
