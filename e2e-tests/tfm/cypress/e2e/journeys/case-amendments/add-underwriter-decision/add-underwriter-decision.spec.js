...
context('Amendments underwriting - add underwriter decision', () => {
  ...
  it('should take you to `Add underwriter decision - Cover End Date` page', () => {
    ...
    pages.amendmentsPage.amendmentCurrentCoverEndDate().contains(oneMonthFormattedFull);
    pages.amendmentsPage.amendmentNewCoverEndDateDay().contains(tomorrowDay);
    pages.amendmentsPage.amendmentNewCoverEndDateDay().contains(todayYear);
  ...
  it('should show underwriter managers decision and sanitised conditions/reasons/comments displayed', () => {
    ...
    amendmentsPage.amendmentManagersDecisionDate(1).contains(todayFormattedFull);
