...
import { oneMonth, today, todayFormattedTimeAmPm, todayFormattedTimeHours, tomorrow } from '../../../../../../e2e-fixtures/dateConstants';
...
context('Amendments underwriting - add underwriter decision', () => {
  ...
  it('should take you to `Add underwriter decision - Cover End Date` page', () => {
    ...
    pages.amendmentsPage.amendmentCurrentCoverEndDate().contains(oneMonth.ddMMMMyyyy);
    pages.amendmentsPage.amendmentNewCoverEndDateDay().contains(tomorrow.day);
  ...
  it('should show underwriter managers decision and sanitised conditions/reasons/comments displayed', () => {
    ...
    amendmentsPage.amendmentManagersDecisionDate(1).contains(today.ddMMMMyyyy);
