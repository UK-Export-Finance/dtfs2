...
import { fourDaysAgo, twoMonths, oneMonth, today } from '../../../../../../e2e-fixtures/dateConstants';
...
context('Amendments - automatic approval journey', () => {
  ...
  describe('Amendment details - Change the Cover end date AND Facility value', () => {
    ...
    it('should take you to `Check your answers page` page', () => {
      ...
      cy.keyboardInput(amendmentsPage.amendmentEffectiveDayInput(), fourDaysAgo.dayLong);
      cy.keyboardInput(amendmentsPage.amendmentEffectiveMonthInput(), fourDaysAgo.monthLong);
      cy.keyboardInput(amendmentsPage.amendmentEffectiveYearInput(), fourDaysAgo.year);
      cy.clickContinueButton();
    ...
    it('should validate the content on `Check your answers` page', () => {
      ...
      amendmentsPage.amendmentAnswerBankRequestDate().should('contain', today.day);
      ...
      amendmentsPage.amendmentAnswerCoverEndDate().should('contain', twoMonths.ddMMMyyyy);
    ...
    it('should display the Automatic approval for Cover end date AND Facility value', () => {
      ...
      amendmentsPage.amendmentDetails.row(1).effectiveDate().should('contain', fourDaysAgo.dMMMMyyyy);
      amendmentsPage.amendmentDetails.row(1).currentCoverEndDate().should('contain', oneMonth.ddMMMMyyyy);
      amendmentsPage.amendmentDetails.row(1).newCoverEndDate().should('contain', twoMonths.ddMMMMyyyy);
  ...
  describe('Amendment details - Change the Facility Value', () => {
    ...
    it('should display amendment changed values on deal and facility page', () => {
      ...
      facilityPage.facilityValueExportCurrency().contains(`${CURRENCY.GBP} 123.00`);
      facilityPage.facilityValueGbp().contains(`${CURRENCY.GBP} 123.00`);
      facilityPage.facilityMaximumUkefExposure().contains(`${CURRENCY.GBP} 24.60 as at ${fourDaysAgo.dMMMMyyyy}`);
