import { MOCK_DEAL_AIN, oneMonth, today, yearWithZeroLetter } from '@ukef/dtfs2-common/test-helpers';
...
context('Amendments - Cover End Date', () => {
  ...
  it('should NOT allow users to enter the same cover end date or with wrong year format', () => {
    ...
    cy.clickContinueButton();
    cy.url().should('contain', 'cover-end-date');
    amendmentsPage.amendmentCurrentCoverEndDate().should('contain', oneMonth.dd_MMMM_yyyy);
