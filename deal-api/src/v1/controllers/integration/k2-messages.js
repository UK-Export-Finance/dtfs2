...
module.exports.generateTypeA = async (deal) => {
  const builder = typeABuilder()
    ...
    .Exporter_address_Line3(deal.submissionDetails['supplier-address-county'])
    ...
    .Exporter_correspondence_address_Line3(deal.submissionDetails['supplier-correspondence-address-county'])
  ...
  // TODO confirm Industry_class_code & Industry_class_name correct fields - Drupal sets both to same value
    ...
    .Indemnifier_address_Line3(deal.submissionDetails['indemnifier-address-county'])
    ...
    .Indemnifier_correspondence_address_Line3(deal.submissionDetails['indemnifier-correspondence-address-county'])
