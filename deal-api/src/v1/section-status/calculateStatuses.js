...
module.exports = (deal, validationErrors) => ({
  ...deal,
  bondTransactions: addAccurateStatusesToBonds(deal.details.status, deal.details.submissionType, deal.bondTransactions, validationErrors.bondErrors),
  loanTransactions: addAccurateStatusesToLoans(deal.details.status, deal.details.submissionType, deal.loanTransactions, validationErrors.loanErrors),
  submissionDetails: {
