...
const { FACILITY_TYPE, DATE_FORMATS } = require('@ukef/dtfs2-common');
const {
  mapIssuedValue,
  facilityFieldsObj,
...
describe('generate AIN/MIN confirmation email facilities list email variable/string  - GEF', () => {
  ...
  describe('facilityFieldsObj', () => {
    ...
    it('should format facilityEndDate to readable format', () => {
      ...
      const expected = format(facilityEndDate, DATE_FORMATS.DO_MMMM_YYYY);
    ...
    it('should format bankReviewDate to readable format', () => {
      ...
      const expected = format(bankReviewDate, DATE_FORMATS.DO_MMMM_YYYY);
