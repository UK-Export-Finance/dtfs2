...
describe('deal submit - add TFM data - deal pricing and risk', () => {
  it('should return default lossGivenDefault', () => {
    const deal = mapSubmittedDeal({ dealSnapshot: MOCK_DEAL_MIN });
  ...
  describe('when submisionType is AIN', () => {
    it('should default exporterCreditRating', () => {
      const deal = mapSubmittedDeal({ dealSnapshot: MOCK_DEAL_AIN });
      const result = dealPricingAndRisk(deal);
  ...
  describe('when dealType is GEF', () => {
    it('should use probabilityOfDefault from the deal\'s exporter', () => {
      const deal = mapSubmittedDeal({ dealSnapshot: MOCK_GEF_DEAL });
      const result = dealPricingAndRisk(deal);
  ...
  describe('when dealType is BSS/EWCS', () => {
    it('should default probabilityOfDefault', () => {
      const deal = mapSubmittedDeal({ dealSnapshot: MOCK_DEAL_AIN });
      const result = dealPricingAndRisk(deal);
