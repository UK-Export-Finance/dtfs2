...
const sendUpdatedTaskEmail = async (task, deal, urlOrigin) => {
  ...
  switch (task.title) {
    ...
    case CONSTANTS.TASKS.MIA_GROUP_1_TASKS.COMPLETE_AGENT_CHECK:
      templateId = CONSTANTS.EMAIL_TEMPLATE_IDS.TASK_READY_TO_START;
      break;

    case CONSTANTS.TASKS.MIA_ADVERSE_HISTORY_GROUP_TASKS.COMPLETE_ADVERSE_HISTORY_CHECK:
      templateId = CONSTANTS.EMAIL_TEMPLATE_IDS.TASK_READY_TO_START;
      break;
    ...
    case CONSTANTS.TASKS.MIA_GROUP_4_TASKS.CHECK_ADVERSE_HISTORY_CHECK:
      templateId = CONSTANTS.EMAIL_TEMPLATE_IDS.TASK_READY_TO_START;
      break;
