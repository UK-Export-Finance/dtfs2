...
const updatePortalFacility = async (facilityId, update) => {
  try {
    ...
    console.error('TFM API - error updating BSS facility: %O', facilityId);
...
const findOneFacility = async (facilityId) => {
  try {
    ...
    console.error('TFM API - error finding BSS facility: %O', facilityId);
...
const updatePortalGefDeal = async (dealId, update) => {
  try {
    ...
    console.error('TFM API - error updating GEF deal %O, %O', dealId, error);
...
const updateGefMINActivity = async (dealId) => {
  try {
    ...
    console.error('TFM API - error updating GEF deal MIN activity %O, %O', dealId, error);
