      ...
      const expected = [
        {
          ...
          fileLocationPath: mockBssDeal.exporterQuestionnaire[0].parentId,
      ...
      const expected = [
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Exporter_questionnaire',
          fileLocationPath: `${mockGefDeal.manualInclusion[0].parentId}/${mockGefDeal.manualInclusion[0].documentPath}`,
          fileName: mockGefDeal.manualInclusion[0].filename,
        },
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Year_to_date_management',
          fileLocationPath: `${mockGefDeal.yearToDateManagement[0].parentId}/${mockGefDeal.yearToDateManagement[0].documentPath}`,
          fileName: mockGefDeal.yearToDateManagement[0].filename,
        },
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Audited_financial_statements',
          fileLocationPath: `${mockGefDeal.auditedFinancialStatements[0].parentId}/${mockGefDeal.auditedFinancialStatements[0].documentPath}`,
          fileName: mockGefDeal.auditedFinancialStatements[0].filename,
        },
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Financial_forecasts',
          fileLocationPath: `${mockGefDeal.financialForecasts[0].parentId}/${mockGefDeal.financialForecasts[0].documentPath}`,
          fileName: mockGefDeal.financialForecasts[0].filename,
        },
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Financial_information_commentary',
          fileLocationPath: `${mockGefDeal.financialInformationCommentary[0].parentId}/${mockGefDeal.financialInformationCommentary[0].documentPath}`,
          fileName: mockGefDeal.financialInformationCommentary[0].filename,
        },
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Corporate_structure',
          fileLocationPath: `${mockGefDeal.corporateStructure[0].parentId}/${mockGefDeal.corporateStructure[0].documentPath}`,
          fileName: mockGefDeal.corporateStructure[0].filename,
        },
        {
          parentId: '6221d87ceee25648b62aa043',
          documentType: 'Audited_financial_statements',
          fileLocationPath: `${mockGefDeal.debtorAndCreditorReports[0].parentId}/${mockGefDeal.debtorAndCreditorReports[0].documentPath}`,
