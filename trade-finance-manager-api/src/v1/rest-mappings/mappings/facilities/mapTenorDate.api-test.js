...
describe('Mapping tenor dates across products', () => {
  ...
  describe('Should return `exposurePeriod` if the facility is issued', () => {
    it('GEF', () => {
      ...
      const result = mapTenorDate(facilitySnapshot.monthsOfCover, tfm.exposurePeriodInMonths);
    ...
    it('BSS/EWCS', () => {
      ...
      const result = mapTenorDate(facilitySnapshot.ukefGuaranteeInMonths, tfm.exposurePeriodInMonths);
      const expected = `${tfm.exposurePeriodInMonths} months`;
