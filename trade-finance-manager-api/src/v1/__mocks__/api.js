...
const MOCK_DEAL_MIN_3 = require('./mock-deal-MIN-3');
const MOCK_DEAL_MIN_4 = require('./mock-deal-MIN-4');
const MOCK_DEAL_MIA = require('./mock-deal-MIA');
const MOCK_DEAL_AIN_SUBMITTED = require('./mock-deal-AIN-submitted');
const MOCK_DEAL_AIN_SUBMITTED_2 = require('./mock-deal-AIN-submitted-2');
