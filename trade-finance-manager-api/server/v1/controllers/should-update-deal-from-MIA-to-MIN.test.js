...
describe('shouldUpdateDealFromMIAtoMIN', () => {
  ...
  it('should log an info message for MIA deal after pre-condition check and before returning response back', () => {
    ...
    expect(consoleInfoSpy).toHaveBeenCalledWith('Updating deal %s submission type to MIN. isMIA=%s, hasApprovedDecision=%s', miaDeal._id, true, true);
  ...
  it('should log an info message for MIA deal after pre-condition check and before returning response back', () => {
    ...
    expect(consoleInfoSpy).toHaveBeenCalledWith('Updating deal %s submission type to MIN. isMIA=%s, hasApprovedDecision=%s', miaDeal._id, true, false);
  ...
  it('should log an info message for an AIN deal after pre-condition check and before returning response back', () => {
    ...
    expect(consoleInfoSpy).toHaveBeenCalledWith('Updating deal %s submission type to MIN. isMIA=%s, hasApprovedDecision=%s', ainDeal._id, false, true);
