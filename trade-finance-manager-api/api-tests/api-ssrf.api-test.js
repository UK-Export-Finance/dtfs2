...
describe('API is protected against SSRF attacks', () => {
  ...
  describe('updateDealSnapshot', () => {
    ...
    it('Returns an error when a url traversal is supplied', async () => {
      ...
      const response = await api.updateDealSnapshot(urlTraversal, 'Mock update', MOCK_TFM_SESSION_USER);
    ...
    it('Returns an error when a local IP is supplied', async () => {
      ...
      const response = await api.updateDealSnapshot(localIp, 'Mock update', MOCK_TFM_SESSION_USER);
    ...
    it('Makes an axios request when the deal id is valid', async () => {
      ...
      const response = await api.updateDealSnapshot(validDealId, 'Mock update', MOCK_TFM_SESSION_USER);
