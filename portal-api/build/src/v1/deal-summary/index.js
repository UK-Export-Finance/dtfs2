...
const canCalculate = (supplyContractCurrency, supplyContractConversionRateToGBP, bonds, loans) => {
    ...
    const hasSupplyContractCurrencyId = ((supplyContractCurrency === null || supplyContractCurrency === void 0 ? void 0 : supplyContractCurrency.id) && hasValue(supplyContractCurrency === null || supplyContractCurrency === void 0 ? void 0 : supplyContractCurrency.id));
...
const calculateDealSummary = (deal) => {
    ...
    if (canCalculate(supplyContractCurrency, supplyContractConversionRateToGBP, bonds, loans)) {
        const { totalValueInDealCurrency: bondsTotalValueInDealCurrency, totalUkefExposureInDealCurrency: bondsTotalUkefExposureInDealCurrency, } = calculateFacilitiesTotalInDealCurrency(bonds);
        const { totalValueInDealCurrency: loansTotalValueInDealCurrency, totalUkefExposureInDealCurrency: loansTotalUkefExposureInDealCurrency, } = calculateFacilitiesTotalInDealCurrency(loans);
        return {
