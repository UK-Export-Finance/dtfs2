...
describe('getNowAsEpoch', () => {
    it('should return as EPOCH representing the current time in milliseconds', () => {
        const result = (0, date_1.getNowAsEpoch)();
    ...
    it('should return EPOCH from getNowAsEpoch function call, whose subsequent value will be either equal or greater than the previous call', () => {
        const previousValue = (0, date_1.getNowAsEpoch)();
        const result = (0, date_1.getNowAsEpoch)();
...
describe('getDateAsEpochMillisecondString', () => {
    it('returns GMT a date correctly', () => {
        ...
        const result = (0, date_1.getDateAsEpochMillisecondString)(mockDate);
...
describe('getStartOfDateFromEpochMillisecondString', () => {
    it('returns GMT time correctly', () => {
        ...
        const result = (0, date_1.getStartOfDateFromEpochMillisecondString)(mockTimeStamp);
...
describe('getStartOfDateFromDayMonthYearStrings', () => {
    it('returns GMT time correctly', () => {
        ...
        const mockMonth = '02';
        const mockYear = '2022';
        const result = (0, date_1.getStartOfDateFromDayMonthYearStrings)(mockDay, mockMonth, mockYear);
...
const getStartOfDateFromDayMonthYearStringsReplicatingMomentTest = (day, month, year, expectedEpoch) => {
    const result = (0, date_1.getStartOfDateFromDayMonthYearStringsReplicatingMoment)(day, month, year);
    expect(result.valueOf()).toEqual(expectedEpoch);
};
describe('getStartOfDateFromDayMonthYearStringsReplicatingMoment', () => {
    ...
    describe('when currentDate is a non-interesting GMT date - 8th March 2023', () => {
        ...
        it('returns the correct value when given valid dates', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest(mockDay, mockMonth, mockYear, 1668211200000));
        ...
        describe('should maintain moment js behaviour for date construction', () => {
            it('should use todays date if invalid date', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest('##', mockMonth, mockYear, 1667865600000));
            it('should use the current year if invalid year', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest(mockDay, mockMonth, '##', 1699747200000));
            it('should round wrap date if too large for the month', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest('31', '02', '2023', 1677801600000));
        });
    });
    ...
    describe('when currentDate is 29th February 2024', () => {
        ...
        it('returns NaN when given an invalid month', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest(mockDay, '##', mockYear, NaN));
        describe('should maintain moment js behaviour for date construction', () => {
            it('should use the 28th if invalid date', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest('##', mockMonth, mockYear, 1669593600000));
            it('should use the current year if invalid year', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest(mockDay, mockMonth, '####', 1731369600000));
        });
    });
    describe('when current date is 31st December', () => {
        ...
        it('returns NaN when given an invalid month', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest(mockDay, '##', mockYear, NaN));
        describe('should maintain moment js behaviour for date construction', () => {
            it('should use the 28th if invalid date', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest('##', mockMonth, mockYear, 1669852800000));
            it('should use the current year if invalid year', () => getStartOfDateFromDayMonthYearStringsReplicatingMomentTest(mockDay, mockMonth, '####', 1731369600000));
        });
    });
});
describe('getLongFormattedDate', () => {
    it('returns date formatted correctly', () => {
        ...
        const result = (0, date_1.getLongFormattedDate)(mockDate);
