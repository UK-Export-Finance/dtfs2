...
module.exports.create = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const userToCreate = req.body;
    const errors = yield applyCreateRules(userToCreate);
    if (errors.length) {
    ...
    const newUser = Object.assign(Object.assign({}, userToCreate), { salt,
        hash });
...
module.exports.updateById = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
        const userIsAdmin = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.roles) === null || _b === void 0 ? void 0 : _b.includes(ADMIN);
        ...
        const userIsChangingTheirOwnPassword = ((_d = (_c = req.user) === null || _c === void 0 ? void 0 : _c._id) === null || _d === void 0 ? void 0 : _d.toString()) === req.params._id && requestOnlyHasPasswordFields;
        if (!userIsAdmin && !userIsChangingTheirOwnPassword) {
            return res.status(403).send();
        }
        return findOne(req.params._id, (error, user) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            if (error) {
                return next(error);
            }
            if (!user) {
            ...
            const errors = yield applyUpdateRules(user, req.body);
            if (errors.length) {
                return res.status(400).json({
                    success: false,
                    errors: {
...
module.exports.login = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { username, password } = req.body;
    const loginResult = yield login(username, password, userService);
...
module.exports.resetPassword = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    yield resetPassword(email, userService);
 ...
 */
module.exports.resetPasswordWithToken = (req, res, next) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield getUserByPasswordToken(resetPwdToken);
    ...
    const errors = yield applyUpdateRules(user, {
        password,
        passwordConfirm,
        currentPassword,
    });
