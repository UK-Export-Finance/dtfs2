...
const updateIssuedFacilities = (user, fromStatus, deal, canUpdateIssuedFacilitiesCoverStartDates, newStatus) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve) => {
        if (deal.facilities.length) {
            deal.facilities.forEach((facilityId) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                ...
                if (shouldUpdateFacility(facility)) {
                    ...
                    yield facilitiesController.update(deal._id, facilityId, facility, user);
                    updatedCount += 1;
                }
