...
const getCountry = (code) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield externalApi.countries.getCountry(code);
        if (!response) {
 ...
 */
const findOne = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield getCountry(req.params.code);
        if (!response) {
            throw new Error('Invalid response');
        }
 ...
 */
const findAll = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const countries = yield externalApi.countries.getCountries();
