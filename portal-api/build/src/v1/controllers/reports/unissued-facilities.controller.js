...
const getUnissuedFacilities = (bankId) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const facilitiesCollection = 'facilities';
    const queryDb = yield db.getCollection(facilitiesCollection);
    ...
    // }]
    const facilities = yield queryDb
        .aggregate([
...
exports.findUnissuedFacilitiesReports = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const bankId = req.user.bank.id;
        const facilities = bankId ? yield getUnissuedFacilities(bankId) : [];
