...
const getUkefDecision = (decision, bankId) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const dealsCollection = 'deals';
    const queryDb = yield db.getCollection(dealsCollection);
    ...
    // }]
    const deals = yield queryDb.aggregate([
        { $unwind: '$ukefDecision' },
...
exports.reviewUkefDecisionReports = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (ukefDecision === CONSTANTS.DEAL.DEAL_STATUS.UKEF_APPROVED_WITHOUT_CONDITIONS
            ...
            const deals = bankId ? yield getUkefDecision(ukefDecision, bankId) : [];
