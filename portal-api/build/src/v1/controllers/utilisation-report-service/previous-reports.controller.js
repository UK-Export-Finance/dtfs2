 ...
 */
const groupReportsByStartYear = (years, reports) => years.map((year) => ({
    year,
...
const getPreviousReportsByBankId = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        return res.status((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.status) !== null && _b !== void 0 ? _b : 500).send({ message: 'Failed to get previous reports' });
    }
});
module.exports = {
