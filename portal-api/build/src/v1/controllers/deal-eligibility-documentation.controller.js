...
exports.update = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    yield findOneDeal(req.params.id, (deal) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const uploadPromises = req.files.map((file) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            const { fieldname, originalname, buffer, size, mimetype, } = file;
            if (size <= FILE_UPLOAD.MAX_FILE_SIZE) {
                const fileInfo = yield fileshare.uploadFile({
        ...
        const uploadedDealFiles = yield Promise.all(uploadPromises, deletePromises);
        const supportingInformation = Object.assign({}, removeDeletedFiles(deal.supportingInformation, req.body.deleteFile));
        uploadedDealFiles.forEach((_a) => {
            var { fieldname } = _a, rest = tslib_1.__rest(_a, ["fieldname"]);
            if (fieldname) {
                ...
                if (!supportingInformation[fieldname].some((df) => df.filename === rest.filename)) {
                    supportingInformation[fieldname].push(Object.assign({}, rest));
                }
            }
        });
        ...
        const updatedDealData = Object.assign(Object.assign({}, deal), { eligibility: {
                status,
                validationErrors: eligibilityCriteriaValidationErrors,
            }, supportingInformation: Object.assign(Object.assign({}, supportingInformation), { securityDetails: {
                    exporter: req.body.security,
                }, validationErrors }) });
        const updatedDeal = yield updateDeal(deal._id, updatedDealData, req.user);
        ...
        const errorList = Object.assign(Object.assign({}, validationErrors.errorList), validationUploadErrors.errorList);
        ...
        const dealWithUploadErrors = Object.assign(Object.assign({}, updatedDeal), { supportingInformation: Object.assign(Object.assign({}, updatedDeal.supportingInformation), validationPlusUploadErrors) });
...
exports.downloadFile = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    return findOneDeal(id, (deal) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        if (!deal) {
