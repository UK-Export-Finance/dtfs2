...
class Application {
    constructor(req, eligibility) {
        ...
        if (eligibility) {
            ...
            const _a = req.maker, { token, password, lastLogin } = _a, sanitisedMaker = tslib_1.__rest(_a, ["token", "password", "lastLogin"]);
            ...
            this.eligibility = Object.assign(Object.assign({}, eligibility), { criteria: eligibility.criteria.map((term) => (Object.assign(Object.assign({}, term), { answer: null }))) });
