...
module.exports = (submittedValues, deal, errorList) => {
    ...
    const { 'requestedCoverStartDate-day': requestedCoverStartDateDay, 'requestedCoverStartDate-month': requestedCoverStartDateMonth, 'requestedCoverStartDate-year': requestedCoverStartDateYear, } = submittedValues;
    ...
    if (!dealHasBeenSubmitted) {
        const { coverDayValidation, coverMonthValidation, coverYearValidation } = coverDatesValidation(requestedCoverStartDateDay, requestedCoverStartDateMonth, requestedCoverStartDateYear);
        ...
        const requestedCoverStartDateHasSomeValues = hasValue(requestedCoverStartDateDay) || hasValue(requestedCoverStartDateMonth) || hasValue(requestedCoverStartDateYear);
