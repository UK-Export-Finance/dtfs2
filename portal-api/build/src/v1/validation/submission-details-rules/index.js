 ...
 */
module.exports = (submissionDetails, deal) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    let errors = {};
    if (submissionDetails === null || submissionDetails === void 0 ? void 0 : submissionDetails.v1Status) {
        return errors;
    }
    for (const rule of rules) {
        errors = yield rule(submissionDetails, errors, deal);
    }
    return errors;
});
