...
module.exports = (submittedValues, errorList, deal) => {
    ...
    const { 'requestedCoverStartDate-day': requestedCoverStartDateDay, 'requestedCoverStartDate-month': requestedCoverStartDateMonth, 'requestedCoverStartDate-year': requestedCoverStartDateYear, specialIssuePermission, } = submittedValues;
