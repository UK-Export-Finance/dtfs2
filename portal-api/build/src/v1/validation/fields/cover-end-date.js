...
module.exports = (submittedValues, deal, errorList) => {
    ...
    const { 'coverEndDate-day': coverEndDateDay, 'coverEndDate-month': coverEndDateMonth, 'coverEndDate-year': coverEndDateYear, requestedCoverStartDate, } = submittedValues;
