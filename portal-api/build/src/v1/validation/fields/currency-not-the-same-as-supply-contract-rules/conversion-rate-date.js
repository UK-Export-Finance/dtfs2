...
module.exports = (facility, errorList, deal) => {
    ...
    const { 'conversionRateDate-day': conversionRateDateDay, 'conversionRateDate-month': conversionRateDateMonth, 'conversionRateDate-year': conversionRateDateYear, v1ExtraInfo, } = facility;
    // only run this validation if first submission - submissionDate does not exist on first submission
    if (!((_a = deal === null || deal === void 0 ? void 0 : deal.details) === null || _a === void 0 ? void 0 : _a.submissionDate)) {
        const { coverDayValidation, coverMonthValidation, coverYearValidation } = coverDatesValidation(conversionRateDateDay, conversionRateDateMonth, conversionRateDateYear);
