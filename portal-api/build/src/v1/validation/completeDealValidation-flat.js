...
module.exports = (deal) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const errors = yield submissionDetailsRules(deal.submissionDetails, deal);
    let validationErrors = Object.assign({}, errors);
    deal.bondTransactions.items.filter((bond) => {
        validationErrors = Object.assign(Object.assign(Object.assign({}, validationErrors), bondRules(bond, deal).errorList), facilityReadyForCheckRequestedCoverStartDateRule(deal, bond));
        return true;
    });
    deal.loanTransactions.items.filter((loan) => {
        validationErrors = Object.assign(Object.assign(Object.assign({}, validationErrors), loanRules(loan, deal).errorList), facilityReadyForCheckRequestedCoverStartDateRule(deal, loan));
        return true;
    });
