...
router
  .route('/application')
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, DATA_ADMIN, ADMIN] }), application.getAll)
...
router
  ...
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, DATA_ADMIN, ADMIN] }), application.getById)
...
router
  ...
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, DATA_ADMIN, ADMIN] }), application.getStatus)
  .put(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, DATA_ADMIN] }), application.changeStatus);

// Facilities
router
  .route('/facilities')
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, DATA_ADMIN, ADMIN] }), facilities.getAllGET)
...
router
  .route('/facilities/:id')
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, DATA_ADMIN, ADMIN] }), facilities.getById)
...
router
  ...
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), eligibilityCriteria.getAll)
  .post(validateUserHasSufficientRole({ allowedNonAdminRoles: [EDITOR, DATA_ADMIN] }), eligibilityCriteria.create);

router.route('/eligibility-criteria/latest').get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), eligibilityCriteria.getLatest);

router
  .route('/eligibility-criteria/:version')
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), eligibilityCriteria.getByVersion)
...
router
  ...
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), mandatoryCriteriaVersioned.findAll)
...
router
  ...
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), mandatoryCriteriaVersioned.findLatest);

router
  .route('/mandatory-criteria-versioned/:id')
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), mandatoryCriteriaVersioned.findOne)
...
router
  .route('/files/:id')
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), files.getById)
  .delete(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, DATA_ADMIN] }), files.delete);

router.route('/files/:id/download').get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, CHECKER, EDITOR, DATA_ADMIN, ADMIN] }), files.downloadFile);

router
  .route('/company/:number') // Companies House
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, DATA_ADMIN, ADMIN] }), externalApi.getByRegistrationNumber);

router
  .route('/address/:postcode') // Ordnance Survey
  .get(validateUserHasSufficientRole({ allowedNonAdminRoles: [MAKER, DATA_ADMIN, ADMIN] }), externalApi.getAddressesByPostcode);
