...
const security = (req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'none';base-uri 'self';block-all-mixed-content;font-src 'self' https: data:;form-action 'self';frame-ancestors 'self';img-src 'self' data:;object-src 'none';script-src 'self' 'unsafe-inline';script-src-attr 'self';style-src 'self' https:;upgrade-insecure-requests");
