    ...
    describe('any Unconditional loans that do NOT have issueFacilityDetailsSubmitted', () => {
      it('should add issueFacilityDetailsSubmitted, submitted timestamp, submitted by and `Completed` status', async () => {
        ...
        loansThatShouldBeUpdated.forEach((loan) => {
          ...
          expect(updatedLoan.submittedAsIssuedBy.username).toEqual(testbank1Checker.username);
          expect(updatedLoan.submittedAsIssuedBy.email).toEqual(testbank1Checker.email);
          expect(updatedLoan.submittedAsIssuedBy.firstname).toEqual(testbank1Checker.firstname);
          expect(updatedLoan.submittedAsIssuedBy.lastname).toEqual(testbank1Checker.lastname);
    ...
    describe('any Issued bonds that do NOT have issueFacilityDetailsSubmitted', () => {
      it('should add issueFacilityDetailsSubmitted, submitted timestamp, submitted by and `Completed` status', async () => {
        ...
        bondsThatShouldBeUpdated.forEach((bond) => {
          ...
          expect(updatedBond.submittedAsIssuedBy.username).toEqual(testbank1Checker.username);
          expect(updatedBond.submittedAsIssuedBy.email).toEqual(testbank1Checker.email);
          expect(updatedBond.submittedAsIssuedBy.firstname).toEqual(testbank1Checker.firstname);
          expect(updatedBond.submittedAsIssuedBy.lastname).toEqual(testbank1Checker.lastname);
