...
const aMaker = users.find((user) => user.username === 'maker1@ukexportfinance.gov.uk');
const anotherMaker = users.find((user) => user.username === 'maker6@ukexportfinance.gov.uk');
