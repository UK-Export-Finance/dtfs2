...
describe('POST /users/me/sign-in-link/:signInToken/login', () => {
  ...
  const loginWithSignInLink = ({ signInToken, userToken }) => as({ token: userToken }).post().to(`/v1/users/me/sign-in-link/${signInToken}/login`);
