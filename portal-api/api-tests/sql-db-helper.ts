import { AzureFileInfoEntity, FeeRecordCorrectionTransientFormDataEntity, FeeRecordEntity, UtilisationReportEntity } from '@ukef/dtfs2-common';
...
type SqlTableName = 'UtilisationReport' | 'FeeRecord' | 'AzureFileInfo' | 'FeeRecordCorrectionTransientFormData';
