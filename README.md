...
| SQL Server DB | SSMS: `Server=localhost:1433;Database=DTFS;User Id=sa;Password=AbC!2345;`<br/>DataGrip: `jdbc:sqlserver://localhost:1433;database=DTFS;user=sa;password=AbC!2345` |
