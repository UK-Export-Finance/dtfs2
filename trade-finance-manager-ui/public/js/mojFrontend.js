        ...
        !(function (e, n) {
          ...
          (C.fn = C.prototype =
            ...
            C.extend({
              ...
              makeArray: function (t, e) {
                var n = e || [];
                return null != t && (j(Object(t)) ? C.merge(n, 'string' == typeof t ? [t] : t) : l.call(n, t)), n;
              },
              ...
              map: function (t, e, n) {
                var o,
                  ...
                  i = 0,
                  a = [];
                if (j(t)) for (o = t.length; i < o; i++) null != (r = e(t[i], i, n)) && a.push(r);
            ...
            (o = st.selectors =
              {
                ...
                pseudos: {
                  ...
                  lt: gt(function (t, e, n) {
                    for (var o = n < 0 ? n + e : n > e ? e : n; --o >= 0; ) t.push(o);
                    return t;
                  }),
            ...
            function Ct(t) {
              for (
                var e,
                  ...
                  p = [
                    function (t, n, o) {
                      var r = (!a && (o || n !== l)) || ((e = n).nodeType ? c(t, n, o) : d(t, n, o));
                      return (e = null), r;
                    },
                  ];
                u < i;
                        ...
                        var n = e.length > 0,
                          ...
                          i = function (i, a, s, u, c) {
                            var d,
                              ...
                              j = k.length;
                            for (c && (l = a == f || a || c); y !== j && null != (d = k[y]); y++) {
                              if (r && d) {
          ...
          (C.filter = function (t, e, n) {
            ...
            C.fn.extend({
              ...
              is: function (t) {
                return !!M(this, 'string' == typeof t && _.test(t) ? C(t) : t || [], !1).length;
              },
            });
          var N,
            $ = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                    ...
                    i &&
                      ...
                      (function e(n) {
                        C.each(n, function (n, o) {
                          v(o) ? (t.unique && l.has(o)) || i.push(o) : o && o.length && 'string' !== T(o) && e(o);
                        });
                      })(arguments),
                      n && !e && u()),
                    this
          ...
          var U = function (t, e, n, o, r, i, a) {
              var s = 0,
                u = t.length,
                l = null == n;
              if ('object' === T(n)) for (s in ((r = !0), n)) U(t, e, s, n[s], !0, i, a);
              else if (
                void 0 !== o &&
                ((r = !0),
                v(o) || (a = !0),
          ...
          function Et(t, e, n, o, r, i) {
            var a, s;
            if ('object' == typeof e) {
              for (s in ('string' != typeof n && ((o = o || n), (n = void 0)), e)) Et(t, s, n, o, e[s], i);
              return t;
            }
            if (
              (null == o && null == r
          ...
          var Bt = /<script|<style|<link/i,
            ...
            Mt = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
          function Nt(t, e) {
            return (B(t, 'table') && B(11 !== e.nodeType ? e : e.firstChild, 'tr') && C(t).children('tbody')[0]) || t;
          }
          function $t(t) {
          ...
          function Ht(t, e, n, o) {
            ...
            var r,
              ...
              h = e[0],
              m = v(h);
            if (m || (p > 1 && 'string' == typeof h && !g.checkClone && Dt.test(h)))
          ...
          function re(t, e, n) {
            var o = Pt(t),
              r = (!g.boxSizingReliable() || n) && 'border-box' === C.css(t, 'boxSizing', !1, o),
              i = r,
              a = Xt(t, e, o),
            ...
            return (
              ((!g.boxSizingReliable() && r) ||
                ...
                'auto' === a ||
                (!parseFloat(a) && 'inline' === C.css(t, 'display', !1, o))) &&
                t.getClientRects().length &&
                ((r = 'border-box' === C.css(t, 'boxSizing', !1, o)), (i = s in t) && (a = t[s])),
          ...
          C.extend({
            ...
            style: function (t, e, n, o) {
              if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                'string' === (i = typeof n) && (r = rt.exec(n)) && r[1] && ((n = ct(t, e, r)), (i = 'number')),
                  null != n &&
                    n == n &&
                    ('number' !== i || u || (n += (r && r[3]) || (C.cssNumber[s] ? '' : 'px')),
            ...
            (ie.propHooks = {
              _default: {
                ...
                set: function (t) {
                  C.fx.step[t.prop]
                    ? C.fx.step[t.prop](t)
                    : 1 !== t.elem.nodeType || (!C.cssHooks[t.prop] && null == t.elem.style[Jt(t.prop)])
                    ? (t.elem[t.prop] = t.now)
          ...
          (C.Animation = C.extend(he, {
            ...
            C.each(['toggle', 'show', 'hide'], function (t, e) {
              ...
              C.fn[e] = function (t, o, r) {
                return null == t || 'boolean' == typeof t ? n.apply(this, arguments) : this.animate(pe(e, !0), t, o, r);
              };
            }),
            C.each(
              {
          ...
          C.fn.extend({
            ...
            C.extend({
              ...
              attrHooks: {
                type: {
                  set: function (t, e) {
                    if (!g.radioValue && 'radio' === e && B(t, 'input')) {
                      var n = t.value;
            ...
            C.each(C.expr.match.bool.source.match(/\w+/g), function (t, e) {
              ...
              ge[e] = function (t, e, o) {
                var r,
                  i,
                  a = e.toLowerCase();
                return o || ((i = ge[a]), (ge[a] = r), (r = null != n(t, e, o) ? a : null), (ge[a] = i)), r;
              };
            });
          ...
          C.fn.extend({
            ...
            C.extend({
              prop: function (t, e, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i)
                  return (
                    (1 === i && C.isXMLDoc(t)) || ((e = C.propFix[e] || e), (r = C.propHooks[e])),
                    void 0 !== n
                      ? r && 'set' in r && void 0 !== (o = r.set(t, n, e))
                        ? o
                        : (t[e] = n)
              ...
              return arguments.length
                ? ((o = v(t)),
                  this.each(function (n) {
                    var r;
                    1 === this.nodeType &&
                      (null == (r = o ? t.call(this, n, C(this).val()) : t)
                        ? (r = '')
                        : 'number' == typeof r
                        ? (r += '')
                        : Array.isArray(r) &&
          ...
          C.extend(C.event, {
            ...
            simulate: function (t, e, n) {
              var o = C.extend(new C.Event(), n, { type: t, isSimulated: !0 });
          ...
          function Me(t, e, n, o) {
            ...
            if (Array.isArray(e))
              C.each(e, function (e, r) {
                n || Ee.test(t) ? o(t, r) : Me(t + '[' + ('object' == typeof r && null != r ? e : '') + ']', r, n, o);
              });
            else if (n || 'object' !== T(e)) o(t, e);
          ...
          C.ajaxSetup({
            ...
            jsonpCallback: function () {
              var t = Ke.pop() || C.expando + '_' + Se.guid++;
              return (this[t] = !0), t;
            },
          }),
                ...
                if (this[0]) {
                  ...
                  if ('fixed' === C.css(o, 'position')) e = o.getBoundingClientRect();
                    ...
                    for (
                      ...
                      t && (t === n.body || t === n.documentElement) && 'static' === C.css(t, 'position');
