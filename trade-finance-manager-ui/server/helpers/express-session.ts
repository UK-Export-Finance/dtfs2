...
/**
 * By default, all session data will be optional (see use of `Partial` [here](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/express-session/index.d.ts#L17))
 *
