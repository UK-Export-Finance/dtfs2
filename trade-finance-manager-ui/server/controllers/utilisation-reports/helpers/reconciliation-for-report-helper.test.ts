...
describe('reconciliation-for-report-helper', () => {
  describe('mapFeeRecordPaymentGroupsToFeeRecordPaymentGroupsViewModelItems', () => {
    ...
    it('maps the group feeRecords id to the view model feeRecords id', () => {
      ...
      // Act
      const viewModel = mapFeeRecordPaymentGroupsToFeeRecordPaymentGroupsViewModelItems(feeRecordPaymentGroups, DEFAULT_IS_CHECKBOX_SELECTED);
    ...
    it('sets isChecked to true if the payment groups fee record ids are recognised by the supplied isCheckboxChecked function', () => {
      ...
      // Act
      const viewModel = mapFeeRecordPaymentGroupsToFeeRecordPaymentGroupsViewModelItems(feeRecordPaymentGroups, isCheckboxChecked);
