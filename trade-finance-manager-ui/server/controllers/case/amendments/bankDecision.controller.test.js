...
describe('controllers - case - amendments', () => {
    ...
    describe('an existing amendment', () => {
      ...
      it('should redirect to received date page when no errors', async () => {
        ...
        const req = {
          ...
          body: {
            banksDecisionChoiceValue: CONSTANTS.AMENDMENTS.AMENDMENT_BANK_DECISION.PROCEED,
          },
          session,
        };
      ...
      it('should render template with errors if no decision provided in body', async () => {
        ...
        const req = {
          ...
          body: { banksDecisionChoiceValue: null },
          session,
        };
  ...
  describe('GET getAmendmentBankDecisionCheckAnswers', () => {
    describe('an existing amendment', () => {
      beforeEach(() => {
        jest.resetAllMocks();
      });
      ...
      it('should render template when amendment is found with effective and received dates in correct format', async () => {
        ...
        await amendmentsController.getAmendmentBankDecisionCheckAnswers(req, res);
  ...
  describe('POST postAmendmentBankDecisionCheckAnswers', () => {
    describe('an existing amendment', () => {
      beforeEach(() => {
        jest.resetAllMocks();
      });
      ...
      it('should redirect to underwriting page when no errors', async () => {
        ...
        await amendmentsController.postAmendmentBankDecisionCheckAnswers(req, res);
