...
describe('amendmentBankReviewDate routes', () => {
  ...
  describe('POST postAmendmentBankReviewDate', () => {
    ...
    describe('incorrect bank review date entered', () => {
      ...
      it("should render the template with the current facility date as undefined if bank review date is not in the facility snapshot and there hasn't yet been an amendment to it", async () => {
