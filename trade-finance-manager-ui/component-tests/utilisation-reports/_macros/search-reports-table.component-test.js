const { UtilisationReportEntityMockBuilder, FeeRecordEntityMockBuilder, UTILISATION_REPORT_STATUS } = require('@ukef/dtfs2-common');
...
describe(component, () => {
  ...
  const getWrapper = ({ isTfmPaymentReconciliationFeatureFlagEnabled } = {}) => {
    ...
    const pendingMockReport = UtilisationReportEntityMockBuilder.forStatus(UTILISATION_REPORT_STATUS.PENDING_RECONCILIATION)
    ...
    const reconciliationInProgressMockReport = UtilisationReportEntityMockBuilder.forStatus(UTILISATION_REPORT_STATUS.RECONCILIATION_IN_PROGRESS)
      .withDateUploaded('2023-12-01T15:04:53Z')
