...
describe(component, () => {
  ...
  describe('value and exposure section', () => {
    ...
    it('should render maximum ukefExposure', () => {
      const expectedTimestamp = filterLocaliseTimestamp(params.facilityTfm.ukefExposure.timestamp, 'd MMMM yyyy', params.user.timezone);
  ...
  describe('`dates` section', () => {
    it('should render inclusionNoticeReceived', () => {
      const expected = filterLocaliseTimestamp(params.facility.dates.inclusionNoticeReceived, 'd MMMM yyyy', params.user.timezone);
      wrapper.expectText('[data-cy="facility-inclusion-notice-received"]').toRead(expected);
    });

    it('should render bankIssueNoticeReceived', () => {
      const expected = filterLocaliseTimestamp(params.facility.dates.bankIssueNoticeReceived, 'd MMMM yyyy', params.user.timezone);
      wrapper.expectText('[data-cy="facility-bank-issue-notice-received"]').toRead(expected);
    });

    it('should render coverStartDate', () => {
      const expected = filterLocaliseTimestamp(params.facility.dates.coverStartDate, 'd MMMM yyyy', params.user.timezone);
