import {
  // getMonthsInSchedule,
  // isScheduleInOrder,
  validateUtilisationReportPeriodSchedule
} from './utilisation-report-period-schedule-validator';
...
describe('utilisation-report-period-schedule-validator', () => {
  ...
  describe('validateUtilisationReportPeriodSchedule', () => {
    ...
    it("returns a validation error as a string when 'utilisationReportPeriodSchedule' is not an array", () => {
      const utilisationReportPeriodSchedule = 'xyz';
      const response = validateUtilisationReportPeriodSchedule(utilisationReportPeriodSchedule);
