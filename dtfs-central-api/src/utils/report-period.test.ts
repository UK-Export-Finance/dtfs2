...
describe('report-period utils', () => {
  describe('parseReportPeriod', () => {
    ...
    `(
      'throws an error if the supplied json object is $condition',
      ({ reportPeriodJsonObject }: { reportPeriodJsonObject: object }) => {
        // Arrange
    ...
    `(
      'throws an error if the report period json object $condition',
      ({ reportPeriodJsonObject }: { reportPeriodJsonObject: object }) => {
        // Arrange
