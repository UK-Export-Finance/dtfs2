...
describe('delete-payment.controller', () => {
  describe('deletePayment', () => {
    ...
    beforeEach(() => {
      ...
      mockForReportId.mockResolvedValue({
        handleEvent: mockHandleEvent,
      });
      UtilisationReportStateMachine.forReportId = mockForReportId;
    });
    ...
    it('deletes the payment and responds with 200', async () => {
      ...
      // Assert
      expect(mockForReportId).toHaveBeenCalledTimes(1);
      expect(mockForReportId).toHaveBeenCalledWith(reportId);
