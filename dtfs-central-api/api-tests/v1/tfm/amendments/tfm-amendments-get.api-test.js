...
describe('GET TFM amendments', () => {
  ...
  describe('GET /v1/tfm/facilities/:id/amendments', () => {
    it('should return all amendments based on facilityId', async () => {
      ...
      const { body: bodyPostResponse } = await TestApi.post({ auditDetails: generateTfmAuditDetails(MOCK_TFM_USER._id) }).to(
      ...
      await TestApi.put({ payload: updatePayload, auditDetails: generateTfmAuditDetails(MOCK_TFM_USER._id) }).to(
        `/v1/tfm/facilities/${facilityId}/amendments/${bodyPostResponse.amendmentId}`,
      );
  ...
  describe('GET /v1/tfm/amendments', () => {
    it('should return 200 status and all amendments that are in progress', async () => {
      ...
      const { body: bodyPostResponse1 } = await TestApi.post({ auditDetails: generateTfmAuditDetails(MOCK_TFM_USER._id) }).to(
        `/v1/tfm/facilities/${facilityId1}/amendments`,
      );
      ...
      await TestApi.put({ payload: updatePayload1, auditDetails: generateTfmAuditDetails(MOCK_TFM_USER._id) }).to(
        `/v1/tfm/facilities/${facilityId1}/amendments/${bodyPostResponse1.amendmentId}`,
      );
      ...
      const { body: bodyPostResponse2 } = await TestApi.post({ auditDetails: generateTfmAuditDetails(MOCK_TFM_USER._id) }).to(
        `/v1/tfm/facilities/${facilityId2}/amendments`,
      );
      const updatePayload2 = { status: CONSTANTS.AMENDMENT.AMENDMENT_STATUS.IN_PROGRESS };
      await TestApi.put({ payload: updatePayload2, auditDetails: generateTfmAuditDetails(MOCK_TFM_USER._id) }).to(
        `/v1/tfm/facilities/${facilityId2}/amendments/${bodyPostResponse2.amendmentId}`,
      );
