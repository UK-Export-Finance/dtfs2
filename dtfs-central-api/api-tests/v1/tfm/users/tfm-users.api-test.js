...
const mockUsers = [
  {
    username: 'T1_USER_1',
    azureOid: 'T1_USER_1@ukexportfinance.gov.uk',
  ...
  {
    username: 'T1_USER_2',
    azureOid: 'T1_USER_2@ukexportfinance.gov.uk',
  ...
  {
    username: 'T1_USER_3',
    azureOid: 'T1_USER_3@ukexportfinance.gov.uk',
...
describe('/v1/tfm/users', () => {
  ...
  describe('POST /v1/tfm/users', () => {
    withValidateAuditDetailsTests({
      makeRequest: (auditDetails) => api.post({ user: mockUsers[0], auditDetails }).to('/v1/tfm/users'),
      validUserTypes: ['tfm'],
    });
