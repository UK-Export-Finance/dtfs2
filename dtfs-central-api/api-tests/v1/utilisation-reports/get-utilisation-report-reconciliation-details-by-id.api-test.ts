...
import { Bank, IsoDateTimeStamp, PortalUser, UTILISATION_REPORT_STATUS, UtilisationReportEntityMockBuilder } from '@ukef/dtfs2-common';
...
describe(`GET ${BASE_URL}`, () => {
  ...
  it('returns a 404 when a bank can not be found with the same id as the bankId in the report', async () => {
    ...
    const reportWithNoMatchingBank = UtilisationReportEntityMockBuilder.forStatus(UTILISATION_REPORT_STATUS.RECONCILIATION_IN_PROGRESS)
