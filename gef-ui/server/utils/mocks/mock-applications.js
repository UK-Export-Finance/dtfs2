...
const { CURRENCY, DEAL_TYPE } = require('@ukef/dtfs2-common');
...
const commonDealItems = {
  ...
  createdAt: String(1638363403942),
  updatedAt: String(1638983294975),
  ...
  exporter: {
    ...
    companiesHouseRegistrationNumber: '0123445',
    industries: [{}],
