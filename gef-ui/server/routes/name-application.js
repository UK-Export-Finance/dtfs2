...
router.get('/name-application', [validateToken, validateRole({ role: [MAKER] })], (req, res) =>
  nameApplication(req, res),
);
router.post('/name-application', [validateToken, validateRole({ role: [MAKER] })], (req, res) =>
