...
router.get('/mandatory-criteria', [validateToken, validateRole({ role: [MAKER] })], (req, res) =>
  getMandatoryCriteria(req, res),
);
router.post('/mandatory-criteria', [validateToken, validateRole({ role: [MAKER] })], (req, res) =>
