...
describe('Routes', () => {
  beforeEach(async () => {
    await import('../facilities/facility-confirm-deletion');
  });
  ...
  it('Sets up all routes', () => {
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/facilities/:facilityId/confirm-deletion');
