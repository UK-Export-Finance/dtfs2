...
describe('Routes', () => {
  ...
  it('Sets up all routes', () => {
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/clone');
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/clone/name-application');
