...
describe('Routes', () => {
  beforeEach(async () => {
    await import('../enter-exporters-correspondence-address');
  });
  ...
  it('Sets up all routes', () => {
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/enter-exporters-correspondence-address');
