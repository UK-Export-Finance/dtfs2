...
describe('Routes', () => {
  beforeEach(async () => {
    await import('../select-exporters-correspondence-address');
  });
  ...
  it('Sets up all routes', () => {
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/select-exporters-correspondence-address');
