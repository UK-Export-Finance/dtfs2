...
describe('Routes', () => {
  beforeEach(async () => {
    await import('../facilities/facilities');
  });
  ...
  it('Sets up all routes', () => {
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/facilities');
    expect(routeSpy).toHaveBeenCalledWith('/application-details/:dealId/facilities/:facilityId');
