...
describe('postCheckYourAnswers', () => {
  ...
  describe('when an amendment has all types of amendments', () => {
    beforeEach(() => {
      ...
      getAmendmentMock.mockResolvedValue(amendmentAllAmendments);
    });
  ...
  describe('when an amendment has no date amendments', () => {
    beforeEach(() => {
      ...
      getAmendmentMock.mockResolvedValue(amendmentNoDates);
    });
  ...
  describe('when an amendment all dates no value', () => {
    beforeEach(() => {
      ...
      getAmendmentMock.mockResolvedValue(amendmentDatesNoValue);
    });
