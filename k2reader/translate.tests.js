...
describe('translate', () => {
  ...
  it('maps ./example-data/type-a-xml/329_NEWDEAL.xml -> ./example-data/contract-json/329_NEWDEAL.json', async () => {
    const xml = await xmlReader('./example-data/type-a-xml/329_NEWDEAL.xml');
    const expectedJson = fs.readFileSync('./example-data/contract-json/329_NEWDEAL.json', 'utf-8');
