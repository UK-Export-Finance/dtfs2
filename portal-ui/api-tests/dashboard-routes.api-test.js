...
const { allDeals, allFacilities, getAllAmendments } = require('../server/api');
...
describe('dashboard routes', () => {
  beforeEach(() => {
    allDeals.mockResolvedValue({ count: 0, deals: [] });
    allFacilities.mockResolvedValue({ count: 0, facilities: [] });
    getAllAmendments.mockResolvedValue([]);
  });
