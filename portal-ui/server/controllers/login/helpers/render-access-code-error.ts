 ...
 */
export const renderAccessCodeErrorView = ({ res, attemptsLeft, email, signInOTP, validationErrors }: RenderAccessCodeErrorViewOptions): void => {
  ...
  res.status(HttpStatusCode.BadRequest).render(CHECK_YOUR_EMAIL_TEMPLATE, viewModel);
};
