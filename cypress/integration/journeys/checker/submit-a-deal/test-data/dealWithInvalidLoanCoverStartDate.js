...
module.exports = () => {
  ...
  const invalidCoverStartDate = moment().subtract(1, 'day');
  ...
  dealWithBadCoverStartDate.loanTransactions.items[0]['requestedCoverStartDate-day'] = moment(invalidCoverStartDate).format('DD');
  dealWithBadCoverStartDate.loanTransactions.items[0]['requestedCoverStartDate-month'] = moment(invalidCoverStartDate).format('MM');
  dealWithBadCoverStartDate.loanTransactions.items[0]['requestedCoverStartDate-year'] = moment(invalidCoverStartDate).format('YYYY');
