...
module.exports = () => {
  ...
  deal.details.submissionType = 'Manual Inclusion Application';
  ...
  deal.loanTransactions.items[0].facilityStage = 'Conditional';
  deal.loanTransactions.items[0].status = 'Submitted';
  deal.loanTransactions.items[0].ukefGuaranteeInMonths = '12';
  return deal;
};
