    ...
    "items": [
      {
        ...
        "requestedCoverStartDate-day": moment().add(1, 'day').format('DD'),
        "requestedCoverStartDate-month": moment().add(1, 'day').format('MM'),
        "requestedCoverStartDate-year": moment().add(1, 'day').format('YYYY'),
        "coverEndDate-day": "02",
