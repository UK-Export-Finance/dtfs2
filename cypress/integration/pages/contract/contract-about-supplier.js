...
const page = {
  ...
  suppliersCorrespondenceAddressDifferent: () => cy.get('[data-cy="suppliersCorrespondenceAddressDifferent-true"]'),
  suppliersCorrespondenceAddressSame: () => cy.get('[data-cy="suppliersCorrespondenceAddressDifferent-false"]'),
