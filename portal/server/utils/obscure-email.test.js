...
describe('obscureEmail', () => {
  ...
  }])('returns the first character before the @, 3 stars, the last character before the @, then the rest of the original string ($original -> $expected)', ({ original, expected }) => {
