  ...
  if (mappedValidationErrors && mappedValidationErrors.errorList) {
    Object.keys(mappedValidationErrors.errorList).forEach((fieldName) => {
      if (
        ...
        mappedValidationErrors.errorList[
          fieldName
        ].href = `/contract/${dealId}/eligibility/criteria#criterion-group-${fieldName}`;
      }
      ...
      if (
        ...
        mappedValidationErrors.errorList[
          fieldName
        ].href = `/contract/${dealId}/eligibility/supporting-documentation#${fieldName}`;
      }
    });
  }
