...
describe('generateTotalFeesAccruedExchangeRateError', () => {
  ...
  it('returns null if accrual currency is the same as base currency', async () => {
    const csvDataRow = {
      exporter: {
        value: testExporterName,
        column: 1,
  ...
  it('returns null if accrual currency is different to base currency and exchange rate is valid', async () => {
    const csvDataRow = {
      exporter: {
        value: testExporterName,
        column: 1,
  ...
  it('returns an error if accrual currency is different to base currency and exchange rate is null', async () => {
    const csvDataRow = {
      exporter: {
        value: testExporterName,
        column: 1,
  ...
  it('returns an error if accrual currency is different to base currency and exchange rate is too long', async () => {
    const csvDataRow = {
      exporter: {
        value: testExporterName,
        column: 1,
