import { generateObject, generateKeywordQuery } from './generate-keyword-query';
...
describe('controllers/dashboard/filters - generate-keyword-query', () => {
  describe('generateObject', () => {
    it('should return an object with given fieldName and keywordValue', () => {
      ...
      const result = generateObject(mockFieldName, mockKeywordValue);

      const expected = {
        [mockFieldName]: {
          REGEX: mockKeywordValue,
          $options: 'i',
        },
      };
  ...
  describe('generateKeywordQuery', () => {
    it('should return an array of objects with given fieldNames and keywordValue', () => {
      const mockFieldNames = [CONSTANTS.FIELD_NAMES.DEAL_TYPE, CONSTANTS.FIELD_NAMES.DEAL.EXPORTER_COMPANY_NAME];
