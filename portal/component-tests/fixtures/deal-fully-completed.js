    ...
    items: [
      {
        ...
        'requestedCoverStartDate-day': `${format(now, CONSTANTS.DATE_FORMATS.DD)}`,
        'requestedCoverStartDate-month': `${format(now, CONSTANTS.DATE_FORMATS.MM)}`,
        'requestedCoverStartDate-year': `${format(now, CONSTANTS.DATE_FORMATS.YYYY)}`,
        'coverEndDate-day': `${format(nextMonth, CONSTANTS.DATE_FORMATS.DD)}`,
        'coverEndDate-month': `${format(nextMonth, CONSTANTS.DATE_FORMATS.MM)}`,
        'coverEndDate-year': `${format(nextMonth, CONSTANTS.DATE_FORMATS.YYYY)}`,
        name: '1234567890',
        ...
        conversionRate: '100',
        'conversionRateDate-day': `${format(yesterday, CONSTANTS.DATE_FORMATS.DD)}`,
        'conversionRateDate-month': `${format(yesterday, CONSTANTS.DATE_FORMATS.MM)}`,
        'conversionRateDate-year': `${format(yesterday, CONSTANTS.DATE_FORMATS.YYYY)}`,
        riskMarginFee: '12',
