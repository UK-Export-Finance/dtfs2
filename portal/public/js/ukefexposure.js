...
!(function () {
  ...
  var e = {
    ...
    t = {};
  e.r(t);
  var n = document.getElementById('facilityValue'),
    r = document.getElementById('coveredPercentage'),
    o = document.getElementById('ukefExposure');
  function u() {
    var e,
      t = n.value.replace(/,/g, '') * (r.value / 100);
    if (
      (function (e) {
      ...
      u =
        ((e = t.toString().split('.')[1]) ? e.length : 0) > 2
          ...
          : t;
      var i = u.toLocaleString('en', { minimumFractionDigits: 2 });
      o.value = i;
    }
  }
  n &&
