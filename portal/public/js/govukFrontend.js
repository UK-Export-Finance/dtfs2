...
!(function () {
    ...
    (a.prototype.getPluralRulesForLocale = function () {
      ...
      for (var n in a.pluralRulesMap)
        if (Object.prototype.hasOwnProperty.call(a.pluralRulesMap, n))
          for (var i = a.pluralRulesMap[n], o = 0; o < i.length; o++) if (i[o] === t || i[o] === e) return n;
    }),
    (a.pluralRulesMap = {
      arabic: ['ar'],
  ...
  function c(t, e) {
    ...
    var s = this.$module.querySelectorAll('.' + this.sectionClass);
  ...
  function T(t, e) {
    var n = { i18n: S };
    if (!(t instanceof HTMLElement)) return this;
    var s = t.querySelector('.govuk-exit-this-page__button');
  ...
  (T.prototype.initUpdateSpan = function () {
    ...
    (T.prototype.handleKeypress = function (t) {
      ('Shift' !== t.key && 16 !== t.keyCode && 16 !== t.which) || this.lastKeyWasModified
        ? null !== this.keypressTimeoutId && this.resetKeypressTimer()
  ...
  (function (t) {
    ...
    (H.prototype.teardown = function () {
      var t = this,
        ...
        i = this.$tabs,
        o = e.querySelector('.govuk-tabs__list'),
        s = e.querySelectorAll('a.govuk-tabs__list-item');
      i &&
        o &&
        s &&
  ...
  var P = (function (t) {
    ...
    var o = e.querySelector('[data-module="govuk-header"]');
    o && new A(o).init(),
