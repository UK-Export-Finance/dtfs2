...
!(function () {
      ...
      return (
        ...
        t.replace(/%{(.\S+)}/g, function (t, o) {
          if (Object.prototype.hasOwnProperty.call(e, o)) {
            var i = e[o];
            return !1 === i || ('number' != typeof i && 'string' != typeof i)
              ? ''
              : 'number' == typeof i
                ? n
                  ? n.format(i)
                  ...
                  d = function () {
                    ...
                    if (i.length)
                      for (n = 0; n < i.length; ++n)
                        if (l.test(i[n]))
                          throw (
                            (((t = new SyntaxError('String "' + i[n] + '" contains an invalid character')).code = 5),
          ...
          var o = function (t, i, r) {
            n(
              ...
              function () {
                ...
                if (((s[a] = !0), !1 === e)) {
                  for (
                    var l, c = o.mirror || document.createElement('div'), u = c.childNodes, d = u.length, h = 0;
                    h < d;
                    ++h
                  )
                    if (u[h]._R === s) {
  ...
  (c.prototype.init = function () {
    ...
    (c.prototype.initSectionHeaders = function () {
      ...
      n(this.$sections, function (e, n) {
        ...
        o &&
          (t.constructHeaderMarkup(o, n),
          t.setExpanded(t.isExpanded(e), e),
          o.addEventListener('click', t.onSectionToggle.bind(t, e)),
          t.setInitialState(e));
      });
    }),
      ...
      if (n && o instanceof HTMLElement && i && r) {
        ...
        a.push(u),
          ...
          t
            ...
            : (r.setAttribute('hidden', 'until-found'),
  ...
  function m(t, e) {
    ...
    if (
      ...
      (this.i18n = new a(i(this.config, 'i18n'), {
        locale: ((r = t), (l = 'lang'), (c = r.closest('[' + l + ']')), c ? c.getAttribute(l) : null),
      })),
      (this.maxLength = 1 / 0),
      ...
      if (e) {
        ...
        if (n && n.classList.contains('govuk-checkboxes__conditional')) {
          ...
          t.setAttribute('aria-expanded', o.toString()),
            n.classList.toggle('govuk-checkboxes__conditional--hidden', !o);
        }
      }
    }),
    ...
    (y.prototype.polyfillDetails = function () {
      ...
      n &&
        ...
        this.$module.hasAttribute('open')
          ...
          : (n.setAttribute('aria-expanded', 'false'), (o.style.display = 'none')),
