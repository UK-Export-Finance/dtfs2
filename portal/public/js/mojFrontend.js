          ...
          (Ge.href = _e.href),
            j.extend({
              ...
              ajaxSettings: {
                ...
                accepts: { '*': Xe, text: 'text/plain', html: 'text/html', xml: 'application/xml, text/xml', json: 'application/json, text/javascript' },
            ...
            j.fn.extend({
              ...
              position: function () {
                if (this[0]) {
                  ...
                  return { top: e.top - r.top - j.css(o, 'marginTop', !0), left: e.left - r.left - j.css(o, 'marginLeft', !0) };
                }
              },
