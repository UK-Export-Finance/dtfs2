...
!(function () {
    ...
    pushLeftBeforeFilled() {
      return this._pushLeft(() => {
        if (!this.block.isFixed && this.block.value)
          return (this.offset = this.block.nearestInputPos(this.offset, h)), this.offset !== 0 || void 0;
      });
    }
    ...
    _rebuildMask() {
      ...
      for (let r = 0; r < e.length; ++r) {
        ...
        const o =
          ...
          void 0 === u ||
          !u.mask ||
          ((n = t[h]) === null || void 0 === n ? void 0 : n.mask.prototype) instanceof i.Masked
            ? { mask: t[h] }
            : t[h];
        const d = l
          ? new C({
    ...
    _appendCharRaw(t) {
      ...
      for (let a = s.index; ; ++a) {
        ...
        const r = s._appendChar(t, {
          ...e,
          _beforeTailState:
            (u = e._beforeTailState) === null || void 0 === u || (n = u._blocks) === null || void 0 === n
              ? void 0
              : n[a],
        });
        const h = r.skip;
  ...
  class y extends w {
    ...
    get rootElement() {
      ...
      let e;
      let s;
      return (t = (e = (s = this.input).getRootNode) === null || void 0 === e ? void 0 : e.call(s)) !== null &&
        void 0 !== t
        ? t
        : document;
    }
  ...
  i.InputMask = class {
    ...
    _onInput(t) {
      ...
      const i = this.masked.splice(e.startChangePos, e.removed.length, e.inserted, e.removeDirection, {
        input: !0,
        raw: !0,
      }).offset;
  ...
  class O extends f {
    ...
    set state(t) {
      ...
      this.compiledMasks.forEach((t, s) => (t.state = e[s])),
        i != null && ((this.currentMask = i), (this.currentMask.state = a)),
        (super.state = u);
    }
